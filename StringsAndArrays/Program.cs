...
namespace StringsAndArrays
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("The length of the hellWorld string is: " + helloWorld.Length);
            ...
            Console.WriteLine("The last character of the string is:" + helloWorld[helloWorld.Length - 1]);
            ...
            int containsName = Array.IndexOf(names, searchName);
            ...
            if (containsName >= 0)
            {
                Console.WriteLine(searchName + " is in the array and has index: " + containsName);
            }
            // 3.2.2 Else output that the searchName was not found
            else { 
                Console.WriteLine(searchName + " wasn't found");
            }
